...
define i32 @add(i32* , i32* , i32* , i32* , i32* , i32* , i32* , i32* , i32* ) {
add23:
  %v24 = alloca i32
  %v25 = alloca i32
  %v26 = alloca i32
...
main74:
  ...
  %v180 = load i32, i32* @M9
  %bool_181 = icmp slt i32 %v179, %v180
...
next_entry178:
  ...
  %v214 = call i32 @add([3 x i32] %v205, [3 x i32] %v206, [3 x i32] %v207, [3 x i32] %v208, [3 x i32] %v209, [3 x i32] %v210, [6 x i32] %v211, [3 x i32] %v212, [3 x i32] %v213)
  store i32 %v214, i32* %v174
  %v215 = alloca i32
  store i32 zeroinitializer, i32* %v215
  %v219 = load i32, i32* %v174
  %v220 = load i32, i32* @N13
  %bool_221 = icmp slt i32 %v219, %v220
...
next_entry218:
  ...
  %v233 = load i32, i32* %v215
  call void @putch(i32 %v233)
  store i32 0, i32* %v174
...
next_entry237:
  store i32 10, i32* %v215
  %v252 = load i32, i32* %v215
  call void @putch(i32 %v252)
  store i32 0, i32* %v174
  %v257 = load i32, i32* %v174
  %v258 = load i32, i32* @N13
  %bool_259 = icmp slt i32 %v257, %v258
